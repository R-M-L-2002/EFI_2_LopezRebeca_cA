...
class EquipoService:
    ...
    def crear_equipo(self, nombre, precio, categoria_id, marca_id, modelo_id, caracteristica_id, accesorio_id):
        nuevo_equipo = Equipo(
            nombre=nombre,
            precio=precio,
    ...
    def editar_equipo(self, equipo_id, nombre, precio, categoria_id, marca_id, modelo_id, caracteristica_id, accesorio_id):
